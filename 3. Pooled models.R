...
pooled_models <- function(data, threshold) {
  ...
  assign(paste0("Pooled", "_imp_1"), m_imp_1, envir = .GlobalEnv)
  assign(paste0("Pooled", "_imp_2"), m_imp_2, envir = .GlobalEnv)
  
  assign(paste0("Pooled", "_saf_1"), m_saf_1, envir = .GlobalEnv)
  assign(paste0("Pooled", "_saf_2"), m_saf_2, envir = .GlobalEnv)
  
  assign(paste0("Pooled", "_eff_1"), m_eff_1, envir = .GlobalEnv)
  assign(paste0("Pooled", "_eff_2"), m_eff_2, envir = .GlobalEnv)
  
  assign(paste0("Pooled", "_rel_1"), m_rel_1, envir = .GlobalEnv)
  assign(paste0("Pooled", "_rel_2"), m_rel_2, envir = .GlobalEnv)
}
